...
from net.model import CATNet as Net
...
def test_Denoise(net, dataset, sigma=15):
    ...
    with torch.no_grad():
        for ([clean_name], degrad_patch, clean_patch) in tqdm(testloader):
            ...
            _,_,_,restored = net(degrad_patch)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gopro_path', type=str, default="test/deblur/", help='save path of test hazy images')
    parser.add_argument('--enhance_path', type=str, default="test/enhance/", help='save path of test hazy images')
    ...
    net = NetModel.load_from_checkpoint(ckpt_path).cuda()
    net.eval()
